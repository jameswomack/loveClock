...
var copenhagenTZ = 'Europe/Copenhagen';
var lastHour = 23;

var LoveClock = function(tz, otherTZ, format) {
  this.tz = tz;
...
Object.defineProperty($$, 'leftDate', {
  get: function () {
    return this.cache.leftDate ? this.cache.leftDate : (this.cache.leftDate = m().tz(this.tz).format('LL'));
  }
});

Object.defineProperty($$, 'rightDate', {
  get: function () {
    return this.cache.rightDate ? this.cache.rightDate : (this.cache.rightDate = m().tz(this.otherTZ).format('LL'));
  }
});
...
$.map = [copenhagenTZ, tokyoTZ, tijuanaTZ].reduce(function (previousValue, currentValue) {
